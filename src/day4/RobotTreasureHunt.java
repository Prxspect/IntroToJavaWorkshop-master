...
it.microMove(30);
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = it.getX();
		int robotYLocation = it.getY();
		...
		if(robotXLocation==720&&robotYLocation==420) {
			JOptionPane.showMessageDialog(null, "Go to the pirate robot for your next clue!");
		}
		// 8. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
		if(robotXLocation==600&&robotYLocation==360) {
			JOptionPane.showMessageDialog(null, "Go to the skull");
		}
		if(robotXLocation==240&&robotYLocation==120) {
			JOptionPane.showMessageDialog(null, "Look for the blue fish in the water to find your treasure!"); }
